...
<a href="https://f-droid.org/repository/browse/?fdid=glaciercore" target="_blank">
<img src="https://f-droid.org/badge/get-it-on.png" alt="Get it on F-Droid" height="80"/></a>
<a href="https://play.google.com/store/apps/details?id=glaciercore" target="_blank">
...
FAQ
-----
You can find the FAQ here (same as in app): http://ics-openvpn.blinkt.com/FAQ.html
...
If you cannot or do not want to use the Play Store you can [download the apk files directly](http://plai.com/android/) .
