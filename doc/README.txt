...
(e.g. from plai.com/android) and placed under main/ovpnlibs/assets/(no)pie_openvpn.{ABI}
...
A: public class StartOpenVPNActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
    	...
    	final String EXTRA_NAME = "glaciercore.shortcutProfileName";

        Intent shortcutIntent = new Intent(Intent.ACTION_MAIN);
		shortcutIntent.setClassName("glaciercore", "glaciercore.LaunchVPN");
...
am start -a android.intent.action.MAIN -n glaciercore/.LaunchVPN -e glaciercore.shortcutProfileName Home

Q: How to control the app from an external app?

A: There is an AIDL interface. See src/com/blinkt/openvpn/api/IOpenVPNAPIService.aidl. See the normal Android documentation how to use AIDL.
