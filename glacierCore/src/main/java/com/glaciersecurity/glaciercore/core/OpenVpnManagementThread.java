...
public class OpenVpnManagementThread implements Runnable, OpenVPNManagement {
    ...
    private static final String TAG = "glaciercore";
    ...
    public boolean managmentCommand(String cmd) {
        try {
            if (mSocket != null && mSocket.getOutputStream() != null) {
                ...
                // GOOBER - Change from flush to loop to hopefully resolve crashing issue
                ...
                // GOOBER - Lem's new method to prevent crash
                int u, v;
                u = 1;
                v = 1;
                while(u < 100000)
