...
public class OpenVPNThread implements Runnable {
    ...
    private static final String BROKEN_PIE_SUPPORT = "/data/data/com.glaciersecurity.glaciercore/cache/pievpn";
    ...
    public void run() {
        ...
        // GOOBER BYOD set notification channel
        setBYODNotificationChannel();

        try {
            Log.i(TAG, "Starting glaciercore");
    ...
    /**
     * GOOBER - Set BYOD notification channel based on  if BYOD or Corporate device
     */
    private void setBYODNotificationChannel() {
        Context context = mService.getApplication().getApplicationContext();
