...
import com.glaciersecurity.glaciercore.core.VpnStatus.ByteCountListener;
import com.glaciersecurity.glaciercore.core.VpnStatus.StateListener;

import static com.glaciersecurity.glaciercore.core.ConnectionStatus.LEVEL_CONNECTED;
import static com.glaciersecurity.glaciercore.core.ConnectionStatus.LEVEL_WAITING_FOR_USER_INPUT;
import static com.glaciersecurity.glaciercore.core.NetworkSpace.ipAddress;
...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal {
    public static final String START_SERVICE = "com.glaciersecurity.glaciercore.START_SERVICE";
    public static final String START_SERVICE_STICKY = "com.glaciersecurity.glaciercore.START_SERVICE_STICKY";
    public static final String ALWAYS_SHOW_NOTIFICATION = "com.glaciersecurity.glaciercore.NOTIFICATION_ALWAYS_VISIBLE";
    public static final String DISCONNECT_VPN = "com.glaciersecurity.glaciercore.DISCONNECT_VPN";
    private static final String PAUSE_VPN = "com.glaciersecurity.glaciercore.PAUSE_VPN";
    private static final String RESUME_VPN = "com.glaciersecurity.glaciercore.RESUME_VPN";
    ...
    synchronized void unregisterDeviceStateReceiver() {
        if (mDeviceStateReceiver != null)
            try {
                ...
                // java.lang.IllegalArgumentException: Receiver not registered: com.glaciersecurity.glaciercore.NetworkSateReceiver@41a61a10
                // Ignore for now ...
                iae.printStackTrace();
            }
    ...
    private OpenVPNManagement instantiateOpenVPN3Core() {
        try {
            Class cl = Class.forName("com.glaciersecurity.glaciercore.core.OpenVPNThreadv3");
    ...
    private void doSendBroadcast(String state, ConnectionStatus level) {
        ...
        vpnstatus.setAction("com.glaciersecurity.glaciercore.VPN_STATUS");
