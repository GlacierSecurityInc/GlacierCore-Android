...
package com.glaciersecurity.glaciercore;
...
import com.glaciersecurity.glaciercore.core.Connection;
import com.glaciersecurity.glaciercore.core.NativeUtils;
import com.glaciersecurity.glaciercore.core.OpenVPNService;
import com.glaciersecurity.glaciercore.core.PasswordCache;
import com.glaciersecurity.glaciercore.core.VPNLaunchHelper;
import com.glaciersecurity.glaciercore.core.VpnStatus;
import com.glaciersecurity.glaciercore.core.X509Utils;
...
public class VpnProfile implements Serializable, Cloneable {
    ...
    public static final String EXTRA_PROFILEUUID = "com.glaciersecurity.glaciercore.profileUUID";
    ...
    public String mSearchDomain = "glaciersecurity.com";
    ...
    // GOOBER Change default value
    public String mConnectRetry = "10";  // GOOBER changed from 2s
    public String mConnectRetryMaxTime = "30";  // GOOBER changed from 300s
    ...
    public String mServerName = "glaciercore.example.com";
    ...
    /**
     * GOOBER BYOD - Add glacier apps to list of apps to be allowed through VPN
     */
    public void addAllowedAppsVpn(Context c) {
        // GOOBER - check if BYOD.  If so, add glacier apps that can use VPN
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(c);
        boolean isBYOD = prefs.getBoolean("byod", false);

        // clear selected apps and reset VPN toggle
        // to non-byod values
        mAllowedAppsVpn.clear();
        mAllowedAppsVpnAreDisallowed = true;

        // check if byod and if so, set values accordingly
        if (isBYOD) {
            // set to false so that it's "VPN is used for only for selected apps"
            ...
            // look for glacier apps to add to list of allowed
            for (ApplicationInfo app : installedPackages) {
                if (app.packageName.toLowerCase().contains("glacier")) {
                    mAllowedAppsVpn.add(app.packageName);
                }
            }
        }
    }
