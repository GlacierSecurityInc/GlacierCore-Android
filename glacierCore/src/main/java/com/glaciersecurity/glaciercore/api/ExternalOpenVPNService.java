...
import com.glaciersecurity.glaciercore.core.ConfigParser;
import com.glaciersecurity.glaciercore.core.ConfigParser.ConfigParseError;
import com.glaciersecurity.glaciercore.core.ConnectionStatus;
import com.glaciersecurity.glaciercore.core.IOpenVPNServiceInternal;
    ...
    private final IOpenVPNAPIService.Stub mBinder = new IOpenVPNAPIService.Stub() {
        ...
        private void startProfile(VpnProfile vp)
        {
            ...
            if(vpnPermissionIntent != null || neddPassword != 0){
                ...
                shortVPNIntent.setClass(getBaseContext(), com.glaciersecurity.glaciercore.LaunchVPN.class);
                shortVPNIntent.putExtra(com.glaciersecurity.glaciercore.LaunchVPN.EXTRA_KEY, vp.getUUIDString());
                shortVPNIntent.putExtra(com.glaciersecurity.glaciercore.LaunchVPN.EXTRA_HIDELOG, true);
