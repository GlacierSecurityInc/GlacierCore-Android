...
public class SendDumpFragment extends Fragment  {
	...
	public void emailMiniDumps()
	{
		...
		uris.add(Uri.parse("content://com.glaciersecurity.glaciercore.FileProvider/" + ldump.first.getName()));
		uris.add(Uri.parse("content://com.glaciersecurity.glaciercore.FileProvider/" + ldump.first.getName() + ".log"));
