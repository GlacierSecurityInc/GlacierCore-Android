...
public class Utils {
    ...
    public static Intent getFilePickerIntent(Context c, FileType fileType) {
        ...
        switch (fileType) {
            ...
            case OVPN_CONFIG:
                i.setType("application/x-glaciercore-profile");
                supportedMimeTypes.add("application/x-glaciercore-profile");
                supportedMimeTypes.add("application/glaciercore-profile");
