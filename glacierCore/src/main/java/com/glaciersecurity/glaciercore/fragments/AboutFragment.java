...
public class AboutFragment extends Fragment implements View.OnClickListener {
    ...
    private void createPlayBuyOptions(ArrayList<String> ownedSkus, ArrayList<String> responseList) {
        try {
            ...
            gdonation.add(new Pair<String, String>(getString(com.glaciersecurity.glaciercore.R.string.donatePlayStore),null));
    ...
    private Pair<String,String> getSkuTitle(final String sku, String title, String price, ArrayList<String> ownedSkus) {
        ...
        if (ownedSkus.contains(sku))
            return new Pair<String,String>(getString(com.glaciersecurity.glaciercore.R.string.thanks_for_donation, price),null);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(com.glaciersecurity.glaciercore.R.layout.about, container, false);
        TextView ver = (TextView) v.findViewById(com.glaciersecurity.glaciercore.R.id.version);
        ...
        try {
            ...
            name = getString(com.glaciersecurity.glaciercore.R.string.app);
        } catch (NameNotFoundException e) {
            version = "error fetching version";
        }


        ver.setText(getString(com.glaciersecurity.glaciercore.R.string.version_info, name, version));
        return v;
    }
