...
void Java_com_glaciersecurity_glaciercore_core_NativeUtils_jniclose(JNIEnv *env,jclass jo, jint fd)
{
	int ret = close(fd);
}
...
jstring Java_com_glaciersecurity_glaciercore_core_NativeUtils_getNativeAPI(JNIEnv *env, jclass jo)
{
